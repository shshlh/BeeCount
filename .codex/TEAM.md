...
| 任务 | 状态 | 负责人 | 产出物 | 完成日期 |
|---|---|---|---|---|
| 7.11.1 账户 ledger_id 数据迁移 | ⬜ 待执行 | architect | schema v40 + ledger_id 回填/孤儿清理 + 日志 | — |
| 7.11.2 账户列表按账本过滤 | ⬜ 待执行 | invest-ui | accounts_page 按账本 provider + 调用点排查 | — |
| 7.11.3 回归测试 | ⬜ 待执行 | qa | 迁移测试 + 删除账本后账户为空回归 | — |
