...
| 7.7.1 版本号 + 正式签名 | ⬜ 待执行 | architect + invest-logic | 1.0.0+1 + release keystore + key.properties + 备份 | — |
| 7.7.2 release 打包回归 + 归档 | ⬜ 待执行 | qa + invest-logic | prod release APK + 实机回归 + v1.0.0 tag + push | — |
