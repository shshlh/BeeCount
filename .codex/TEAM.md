...
| 任务 | 状态 | 负责人 | 产出物 | 完成日期 |
|---|---|---|---|---|
| 7.14.1 流水 tab 增加「全部」 | ⬜ 待执行 | invest-ui | 全部/支出/收入 默认全部 + flow=null 全部流水 | — |
| 7.14.2 逐笔余额 | ⬜ 待执行 | invest-logic + invest-ui | 余额小字 + initialBalance 时间升序累计 | — |
| 7.14.3 测试 | ⬜ 待执行 | qa | tab 切换 + 逐笔余额累计 + 转出转入 | — |
