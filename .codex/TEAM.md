...
| 任务 | 状态 | 负责人 | 产出物 | 完成日期 |
|---|---|---|---|---|
| 7.17.1 净值历史表 | ⬜ 待执行 | architect | fund_nav_history + schema v41 | — |
| 7.17.2 净值抓取扩展 | ⬜ 待执行 | invest-logic | 最近 3 档净值 + 历史表写入 | — |
| 7.17.3 收益/涨跌幅计算 | ⬜ 待执行 | invest-logic | 今日/昨日收益 + 涨跌纯函数 + 单测 | — |
| 7.17.4 非交易日判断 + 节假日数据源 | ⬜ 待执行 | invest-logic | HolidayCalendar + 2026/2027 节假日 | — |
| 7.17.5 刷新与部分/全部更新 | ⬜ 待执行 | invest-logic + invest-ui | 20:00 后轮询 + nav_date 前进判断 + 状态 | — |
| 7.17.6 持仓卡片 UI | ⬜ 待执行 | invest-ui | 今日/昨日收益 + 涨跌 + 日期 + 状态 | — |
| 7.17.7 测试 | ⬜ 待执行 | qa | 计算/非交易日/历史/状态/UI 测试 | — |
